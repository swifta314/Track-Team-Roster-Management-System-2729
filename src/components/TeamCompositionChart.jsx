...
const TeamCompositionChart = ({ genderFilter, teamComposition }) => {
        ...
        return (
          <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
            ...
            <div className="mt-2 space-y-1">
              <p className="text-xs">
                <span className={`${genderFilter === 'men' ? 'text-blue-600' : 'text-pink-600'} font-medium`}>
  ...
  const renderGenderDistribution = () => {
    if (genderFilter === 'men') {
      return (
        <div>
          <p className="text-sm text-gray-600">Men's Team</p>
      ...
      return (
        <div>
          <p className="text-sm text-gray-600">Women's Team</p>
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <h3 className="font-semibold text-gray-900 mb-2">Graduation Timeline</h3>
          <div className="space-y-2">
            {teamComposition.graduationTimeline.map((item, index) => (
              <div key={index} className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Class of {item.year}:</span>
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-900">{item.graduating} athletes</span>
                  <div 
                    className="h-3 bg-ballstate-red rounded-full" 
